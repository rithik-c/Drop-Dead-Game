...
class AutoDropDeadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auto_drop_dead" do
    assert_difference("AutoDropDead.count") do
      post auto_drop_deads_url, params: { auto_drop_dead: { dice_count: @auto_drop_dead.dice_count, player_count: @auto_drop_dead.player_count, sides: @auto_drop_dead.sides } }
    end
  ...
  test "should update auto_drop_dead" do
    patch auto_drop_dead_url(@auto_drop_dead), params: { auto_drop_dead: { dice_count: @auto_drop_dead.dice_count, player_count: @auto_drop_dead.player_count, sides: @auto_drop_dead.sides } }
